...
import com.example.taskmanagementapplication.databinding.ActivityCompletedTasksBinding;
...
public class CompletedTasksActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        List<Task> taskList = taskDao.userCompletedTasks(userIdInt);
        ...
        ItemTouchHelper.SimpleCallback swipeCallback = new ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.LEFT) {
            ...
            public void onSwiped(@NonNull RecyclerView.ViewHolder viewHolder, int direction) {
                ...
                if (direction == ItemTouchHelper.LEFT) {
                    ...
                    Snackbar.make(taskRecyclerView, "Permanently Deleted: " + task.getTitle(), Snackbar.LENGTH_LONG)
            ...
            public void onChildDraw(@NonNull Canvas c, @NonNull RecyclerView recyclerView, @NonNull RecyclerView.ViewHolder viewHolder, float dX, float dY, int actionState, boolean isCurrentlyActive) {
                new RecyclerViewSwipeDecorator.Builder(c, recyclerView, viewHolder, dX, dY, actionState, isCurrentlyActive)
                        .addSwipeLeftBackgroundColor(ContextCompat.getColor(CompletedTasksActivity.this, R.color.red))
